...
# Create a list called 'mixed' containing: an int, a string, a float, a bool, and None
# Use the values: 1, "two", 3.0, True, None (in that order)
mixed = ???
...
# Reverse the list using slicing (hint: use a negative step)
reversed_list = ???
...
# Repeat list_a three times (hint: use the * operator)
repeated = ???
